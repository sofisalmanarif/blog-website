...
console.log("session",data)
  ...
  React.useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ['machine learning','coding', 'web development', 'software development', 'data science', 'artificial intelligence'],
      typeSpeed: 70,
    });
    ...
    <main>
      ...
      <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
        <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
          Discover <span className="font-bold">Inspiring Stories</span> and <br className="hidden lg:block" /> Insights on   <span className="font-bold text-[#DFD5FF] underline decoration-[#DFD5FF]"  ref={el} ></span>
        </h1>
    ...
    <h2 className="text-4xl text-center font-extrabold mb-8 dark:text-white text-black  sm:text-5xl">
      ...
      <div className="flex justify-center max-w-[14rem] m-auto mb-8 lg:mb-16">
        <div className="relative flex w-full p-1 bg-white dark:bg-slate-900 rounded-full">
          ...
          >
            Yearly <span className={`text-indigo-200 ${isAnnual ? 'text-indigo-200' : 'text-slate-400 dark:text-slate-500'}`}>-20%</span>
          </button>
          <button
      ...
      <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
        ...
        <div className="h-full">
          <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
            <div className="mb-5">
              <div className="text-slate-900 dark:text-slate-200 font-semibold mb-1">Elite</div>
              <div className="inline-flex items-baseline mb-2">
                <span className="text-slate-900 dark:text-slate-200 font-bold text-3xl">$</span>
                <span className="text-slate-900 dark:text-slate-200 font-bold text-4xl">{isAnnual ? '99' : '105'}</span>
                <span className="text-slate-500 font-medium">/mo</span>
              </div>
              <div className="text-sm text-slate-500 mb-5">There are many variations available, but the majority have suffered.</div>
              <a className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-indigo-500 px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:bg-indigo-600 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 transition-colors duration-150" href="#0" target="_blank" rel="noopener noreferrer">
    ...
    <div className="py-16">
        <div className="mx-auto px-6 max-w-6xl text-gray-500">
            <div className="text-center">
                <h2 className="text-3xl text-gray-950 dark:text-white font-semibold">Seamlessly integrates with  your favorite frontend tools</h2>
                <p className="mt-6 text-gray-700 dark:text-gray-300">Orrupti aut temporibus ariatur.</p>
            </div>
            <div className="mt-12 relative w-fit h-fit sm:mx-auto sm:px-0 -mx-6 px-6 overflow-x-auto">
                ...
                <div className="flex w-fit mx-auto gap-3">
                    ...
                    <div className="border flex relative *:relative *:size-7 *:m-auto size-20 mx-auto rounded-xl dark:bg-gray-900 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-100 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-950">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 128 128">
                            <path className="text-[#014847] dark:text-white" fill="currentColor" d="M80.46 82.605h-8.777l-.734-.733V61.326c0-3.656-1.436-6.489-5.844-6.588c-2.269-.06-4.864 0-7.638.11l-.416.425v26.589l-.733.733H47.54l-.733-.733V46.764l.733-.733h19.753c7.677 0 13.899 6.22 13.899 13.898v21.943z"></path>
                            <path className="text-[#05bdba]" fill="currentColor" d="M58.942 119.902v-26.33l.733-.734h8.797l.733.733v26.331l-.733.733h-8.796zm0-84.838V8.734L59.675 8h8.797l.733.733v26.331l-.733.733h-8.796zm68.335 34.385H92.169l-.733-.733V59.92l.733-.733h35.108l.733.733v8.797zm-91.436 0H.733L0 68.716V59.92l.733-.733h35.108l.733.733v8.797zm-8.49-35.633v-1.209l6.034-6.033h1.208l9.223 9.223v6.39l-.852.852h-6.39zm7.242 68.235h-1.208l-6.033-6.033v-1.209l9.223-9.222h6.39l.851.851v6.39z"></path>
                        </svg>
                    </div>
                    <div className="border flex relative *:relative *:size-7 *:m-auto size-20 mx-auto rounded-xl dark:bg-gray-900 dark:border-white/15 before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-100 dark:before:border-white/20 before:bg-gradient-to-b dark:before:from-white/10 dark:before:to-transparent before:shadow dark:before:shadow-gray-950">
