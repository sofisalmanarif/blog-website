  ...
  Have a question, collaboration idea, or just want to say hello? Feel free to get in touch, we're here to help!
                ...
                <form action="#" className="space-y-8">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <textarea id="message" aria-rowcount={6} className="block p-2.5 w-full text-sm text-gray-900 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500  dark:border-gray-600 dark:bg-black dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Leave a comment..."></textarea>
                    </div>
